...
<body>
  ...
  <div class="wrapper bg-white">
        <div class="h2 text-center">Centrar Space Center</div>
        <div class="h4 text-muted text-center pt-2">Inicia Sesión</div>
        <form class="pt-3" action="validar_login.php" method="post">
            ...
            <div class="d-flex align-items-start">
                ...
                <br>
                <div class="ml-auto">
                    <a href="registro.php" id="forgot">Has olvidado la contraseña?</a>
                </div>
            </div>
            <button class="btn btn-block text-center my-3" type="submit">Ingresar</button>
            <div class="text-center pt-3 text-muted">No te has registrado? <a href="registro.php">Registrase</a></div>
        </form>
    </div>
