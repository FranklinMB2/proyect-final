...
$sql = $con->prepare(" SELECT id, nombre, precio FROM productos WHERE id_categoria = 1 ");
$sql->execute();
  ...
  <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="img/accesorio1.jpg" class="d-block w-100" alt="general">
      </div>
      <div class="carousel-item">
        <img src="img/accesorio2.png" class="d-block w-100" alt="general">
      </div>
      <div class="carousel-item">
        <img src="img/accesorio3.jpg" class="d-block w-100" alt="general">
      </div>
      <div class="carousel-item">
        <img src="img/accesorio4.webp" class="d-block w-100" alt="general">
      </div>
    </div>
