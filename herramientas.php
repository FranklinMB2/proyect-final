...
$sql = $con->prepare(" SELECT id, nombre, precio FROM productos WHERE id_categoria = 2 ");
$sql->execute();
    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="img/herramienta1.jpg" class="d-block w-100" alt="general">
            </div>
            <div class="carousel-item">
                <img src="img/herramienta2.jpg" class="d-block w-100" alt="general">
            </div>
            <div class="carousel-item">
                <img src="img/herramienta3.jpg" class="d-block w-100" alt="general">
            </div>
            <div class="carousel-item">
                <img src="img/herramienta4.jpg" class="d-block w-100" alt="general">
            </div>
        </div>
